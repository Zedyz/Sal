...
class DecoderHead(nn.Module):
    def __init__(self, embed_dim=768, hidden_dim=512):
        super().__init__()
    ...
    def forward(self, tokens):
        ...
        out = self.sal_fc(up_4d)  # => [B,40,60,1]
        out = out.permute(0, 3, 1, 2)  # => [B,1,40,60]
...
class ComponentSaliencyNet(nn.Module):
    ...
    def __init__(self, embed_dim=768, hidden_dim=512):
        ...
        self.res1 = ResidualMLP(64)
        self.res2 = ResidualMLP(64)
        self.res3 = ResidualMLP(64)
...
class Model(nn.Module):
    def __init__(self):
        super().__init__()
        self.backbone = timm.create_model('vit_base_patch16_224', pretrained=True, in_chans=3)
        ...
        self.csp = CSPNet(embed_dim=self.embed_dim, hidden_dim=512)
